...
export const updateGastronomia = async (id, plato) => {
    try {
        ...
        console.error("Error updateGastronomia:", error);
        throw error;
    }
};

export const deleteGastronomia = async (id) => {
    try {
        const response = await fetch(`${API_URL}/${id}`, {
            method: 'DELETE'
        });
        ...
        console.error("Error deleteGastronomia:", error);
        throw error;
    }
};
